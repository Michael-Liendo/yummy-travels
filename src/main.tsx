...
import "./index.css";
import { RegisterTrip } from "./routes/admin/RegisterTrip.tsx";
import { TicketsVendidos } from "./routes/admin/TicketsVendidos.tsx";
...
ReactDOM.createRoot(document.getElementById("root")!).render(
  <BrowserRouter>
    <Routes>
      ...
      <Route path="/admin" element={<RegisterTrip />} />
      <Route path="/admin/sells" element={<TicketsVendidos />} />
    </Routes>
  </BrowserRouter>
);
