...
export default function App() {
  const [travelForm, setTravelForm] = useState<{ current_address: string, address: string, travel_date: string, passengers: number }>({ current_address: '', address: '', travel_date: '', passengers: 0 })
  ...
  return (
    <form onSubmit={handleSubmit} className="px-5 mt-5">
      ...
      <div className='flex justify-end'>
        <Button color="purple" type="submit">Buscar viaje</Button>
      </div>
    </form>
  )
}